...
class DonorsStream(DonorPerfectStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property("no_email_reason", th.StringType),
        th.Property("email_type", th.StringType),
        th.Property("email_status", th.StringType),
        th.Property("email_status_date", th.StringType),
        th.Property("opt_out_source", th.StringType),
        th.Property("opt_out_reason", th.StringType),
        ...
        th.Property("em_campaign", th.StringType),
        th.Property("em_campaign_status", th.StringType),
        th.Property("contact_state", th.StringType),
        th.Property("em_event_status_date", th.StringType),
        th.Property("em_bounce_reason", th.StringType),
        th.Property("contact_email", th.StringType),
        th.Property("activity_code", th.StringType),
    ).to_dict()
    params = [
        {
            "name": "action",
